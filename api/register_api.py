...
def register_api(data:RegisterRequest):
    logger.info(f"API Request: User registration attempt for username: {data.username}")
    ...
    logger.info(f"API Response: Registration completed for username: {data.username}")
